...
export default function Home() {
  return (
    <>
      <header className="bg-white shadow-md py-2 px-6 fixed h-[95px] w-full top-0 z-100">
      ...
      <main className="flex-1 h-[calc(100vh-64px)] bg-white">
        <section
          aria-label="hero-section"
          className="snap-center h-screen pt-[95px] flex bg-linear-to-b from-gray-300 via-gray-500 to-gray-700"
        >
          <div className="relative flex justify-center w-full mx-auto">
            <div className="flex flex-col justify-center pt-40 items-start gap-5 text-white">
              <span className="flex flex-col">
                <p className="font-bold text-[4rem]">LB Apparel</p>
                <p className="text-base">“Discover timeless pieces designed for comfort, <br /> style, and confidence every day”</p>
              </span>
              <button className="bg-gray-800 cursor-pointer px-5 py-3 rounded-full text-white border-transparent text-base">SHOP NOW  🡢</button>
            </div>
            <div className="absolute">
              <p
                className="font-semibold text-[16rem] tracking-[15px] text-shadow-lg text-gray-600"
              >
                SHEESH
              </p>
            </div>
        ...
        <section
          ...
          className="snap-center py-30 flex items-center bg-white"
        >
        ...
        <section
          ...
          className="snap-center flex bg-gray-300 px-5 py-60 items-center"
        >
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col gap-20 w-full ">
              ...
              <div className="w-full flex justify-center px-28">
                <p className="italic text-center text-black">
        ...
        <section
          aria-label="About us"
          className="snap-center h-[calc(100vh-64px)] flex items-center py-10 bg-white"
        >
          <div className="max-w-7xl mx-auto">
            <div className="w-full">
              <div className="mb-8 text-center">
